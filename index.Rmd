...
The current version of the application is here (https://github.com/beaisis/DataProducts).

Supporting code and documentation for the application is on gitHub (https://beaisis.shinyapps.io/Solar/)
